...
@WebServlet(name = "ManagerNotificationServlet", urlPatterns = {"/manager/notifications"})
public class ManagerNotificationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("CONTENT_PAGE", "/view/manager/notification/notification-manager.jsp");
