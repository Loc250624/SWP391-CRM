...
public class SaleTaskStatusServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/view/sale/pages/task/status.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (taskIdParam == null || statusParam == null) {
            request.setAttribute("errorMessage", "Thiếu thông tin cập nhật trạng thái.");
            request.getRequestDispatcher("/view/sale/pages/task/list.jsp").forward(request, response);
            return;
        }
