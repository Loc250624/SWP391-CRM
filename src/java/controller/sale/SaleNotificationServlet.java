...
@WebServlet(name = "SaleNotificationServlet", urlPatterns = {"/sale/notifications"})
public class SaleNotificationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Page render
        request.setAttribute("ACTIVE_MENU", "NOTIFICATIONS");
        request.setAttribute("pageTitle", "Thông báo");
        request.setAttribute("CONTENT_PAGE", "/view/sale/pages/notification-list.jsp");
