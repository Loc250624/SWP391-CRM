...
<head>
    ...
    <style>
        ...
        .sidebar a { padding: 15px 25px; text-decoration: none; font-size: 16px; color: #cbd5e1; display: block; transition: 0.3s; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/support/dashboard" class="active"><i class="fa-solid fa-chart-line"></i> Tổng quan</a>
        <a href="#"><i class="fa-solid fa-ticket"></i> Quản lý Ticket</a>
        
        <a href="${pageContext.request.contextPath}/support/customers"><i class="fa-solid fa-users"></i> Quản lý Customer</a>
    ...
    <div class="main-content">
        <div class="header-profile">
            <div><h4 style="font-weight: 600; margin: 0;">Tổng quan</h4></div>
        ...
        <div class="empty-state">
            ...
            <h5>Chào mừng quay trở lại!</h5>
            <p>Chọn <b>Quản lý Customer</b> để xem danh sách khách hàng.</p>
        </div>
    </div>
