...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-outline-secondary btn-sm" onclick="csNotifPage.markAllRead()">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <select class="form-select form-select-sm" style="width:auto;" id="filterRead" onchange="csNotifPage.loadList()">
        ...
        <div class="card-footer bg-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group btn-group-sm">
                    <button class="btn btn-outline-secondary" id="btnPrev" onclick="csNotifPage.prevPage()" disabled>
                        <i class="bi bi-chevron-left"></i>
                    </button>
                    <button class="btn btn-outline-secondary" id="btnNext" onclick="csNotifPage.nextPage()">
...
var csNotifPage = (function () {
    ...
    function typeLabel(type) {
        switch (type) {
            ...
            case 'CUSTOMER_STATUS_CHANGED': return 'Trạng thái KH';
            ...
            .then(function (data) {
                ...
                for (var i = 0; i < data.notifications.length; i++) {
                    ...
                    var actionUrl = n.actionUrl
                        ? '${pageContext.request.contextPath}/support' + n.actionUrl
                        : 'javascript:void(0)';

                    html += '<a href="' + actionUrl + '" class="list-group-item list-group-item-action ' + unreadClass + '" onclick="csNotifPage.markRead(' + n.id + ')">'
